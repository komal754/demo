...
function CommunityArea() {
  return (
	<div className="community-area primary-bg pt-120 pb-175">
                    ...
                    <ul>
                      <li>
                        <div className="sidebar-new-game-thumb">
                          <a href="/#">
                            <img src="assets/img/images/sidebar_new_game01.jpg" alt="BrandImg" />
                          </a>
                        </div>
                      ...
                      <li>
                        <div className="sidebar-new-game-thumb">
                          <a href="/#">
                            <img src="assets/img/images/sidebar_new_game02.jpg" alt="BrandImg" />
                          </a>
                        </div>
                        <div className="sidebar-new-game-content">
                          <span>Yesterday 12 : 19</span>
                      ...
                      <li>
                        <div className="sidebar-new-game-thumb">
                          <a href="/#">
                            <img src="assets/img/images/sidebar_new_game03.jpg" alt="BrandImg" />
                          </a>
                        </div>
                        <div className="sidebar-new-game-content">
                          <span>Yesterday 12 : 19</span>
        ...
        <div className="community-bg-shape"><img src="assets/img/images/community_bg_shape.png" alt="BrandImg" /></div>
      </div>
  )
}
