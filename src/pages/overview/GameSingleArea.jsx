                ...
                <div className="row mt-55 mb-55">
                  <div className="col-lg-6 order-0 order-lg-2">
                    <div className="overview-history-img">
                      <img src="assets/img/images/overview_history_img.jpg" alt="BrandImg" />
                    </div>
                  </div>
                        ...
                        <ul>
                          <li>
                            <div className="overview-list-thumb">
                              <img src="assets/img/images/overview_history_thumb01.jpg" alt="BrandImg" />
                            </div>
                          ...
                          <li>
                            <div className="overview-list-thumb">
                              <img src="assets/img/images/overview_history_thumb02.jpg" alt="BrandImg" />
                            </div>
                            <div className="overview-list-content">
                              <h4><a href="/#">CONSOLE UPDATE 6.2</a></h4>
                              <span>1st place November 9, 2022</span>
