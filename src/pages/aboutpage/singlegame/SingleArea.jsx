                ...
                <div className="game-single-img">
                  <div className="row">
                    <div className="col-sm-6">
                      <img src="assets/img/images/game_single_img01.jpg" alt="BrandImg" />
                    </div>
                    <div className="col-sm-6">
                      <img src="assets/img/images/game_single_img02.jpg" alt="BrandImg" />
                    </div>
                  </div>
                </div>
                <p>Donec orci enim, bibendum a augue quis, aliquet cursus quam. Pellentesque pulvinar, elit at condimentum dictum, sapien
                ...
                <div className="game-single-gallery">
                  <div className="row">
                    <div className="col-lg-4 col-sm-6">
                      <img src="assets/img/images/game_single_gallery01.jpg" alt="BrandImg" />
                    </div>
                    <div className="col-lg-4 col-sm-6">
                      <img src="assets/img/images/game_single_gallery02.jpg" alt="BrandImg" />
                    </div>
                    <div className="col-lg-4 col-sm-6">
                      <img src="assets/img/images/game_single_gallery03.jpg" alt="BrandImg" />
                    </div>
                    <div className="col-lg-4 col-sm-6">
                      <img src="assets/img/images/game_single_gallery04.jpg" alt="BrandImg" />
                    </div>
                    <div className="col-lg-4 col-sm-6">
                      <img src="assets/img/images/game_single_gallery05.jpg" alt="BrandImg" />
                    </div>
                    <div className="col-lg-4 col-sm-6">
                      <img src="assets/img/images/game_single_gallery06.jpg" alt="BrandImg" />
                    </div>
                  </div>
                </div>
                <div className="game-single-shape"><img src="assets/img/images/game_section_shape.png" alt="BrandImg" /></div>
              </div>
            </div>
          </div>
        </div>
