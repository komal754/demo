          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="upcoming-game-item mb-40">
                ...
                <div className="upcoming-game-thumb">
                  <img src="assets/img/images/upcoming_game_thumb01.jpg" alt="BrandImg" />
            ...
            <div className="col-lg-4 col-md-6">
              <div className="upcoming-game-item mb-40">
                ...
                <p>Compete with players remote island winner takes showdown known issue.</p>
                <div className="upcoming-game-thumb">
                  <img src="assets/img/images/upcoming_game_thumb02.jpg" alt="BrandImg" />
                  <div className="upcoming-game-cart">
                    <a href="/#" className="btn transparent-btn"><i className="fas fa-shopping-basket" />BUY Now</a>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="upcoming-game-item mb-40">
                ...
                <p>Compete with players remote island winner takes showdown known issue.</p>
                <div className="upcoming-game-thumb">
                  <img src="assets/img/images/upcoming_game_thumb03.jpg" alt="BrandImg" />
                  <div className="upcoming-game-cart">
                    <a href="/#" className="btn transparent-btn"><i className="fas fa-shopping-basket" />BUY Now</a>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="upcoming-game-item mb-40">
                ...
                <p>Compete with players remote island winner takes showdown known issue.</p>
                <div className="upcoming-game-thumb">
                  <img src="assets/img/images/upcoming_game_thumb04.jpg" alt="BrandImg" />
                  <div className="upcoming-game-cart">
                    <a href="/#" className="btn transparent-btn"><i className="fas fa-shopping-basket" />BUY Now</a>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="upcoming-game-item mb-40">
                ...
                <p>Compete with players remote island winner takes showdown known issue.</p>
                <div className="upcoming-game-thumb">
                  <img src="assets/img/images/upcoming_game_thumb05.jpg" alt="BrandImg" />
                  <div className="upcoming-game-cart">
                    <a href="/#" className="btn transparent-btn"><i className="fas fa-shopping-basket" />BUY Now</a>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="upcoming-game-item mb-40">
                ...
                <p>Compete with players remote island winner takes showdown known issue.</p>
                <div className="upcoming-game-thumb">
                  <img src="assets/img/images/upcoming_game_thumb06.jpg" alt="BrandImg" />
                  <div className="upcoming-game-cart">
                    <a href="/#" className="btn transparent-btn"><i className="fas fa-shopping-basket" />BUY Now</a>
                  </div>
                </div>
