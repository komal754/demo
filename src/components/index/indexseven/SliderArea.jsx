          ...
          <div className="row justify-content-between align-items-center">
            ...
            <div className="col-xl-5 col-lg-6">
              <div className="h-seven-slider-img text-center">
                  ...
                  <img src="assets/img/slider/shop_slider_img01.png" alt="BrandImg" />
                  </Slide>
        ...
        <div className="container custom-container">
          <div className="row justify-content-between align-items-center">
            ...
            <div className="col-xl-5 col-lg-6">
              <div className="h-seven-slider-img text-center">
              <Slide right delay={.4000}>
              <img src="assets/img/slider/shop_slider_img02.png" alt="BrandImg" />
              </Slide>
              </div>
            </div>
          </div>
      ...
      <div className="h-seven-slider-item">
        <div className="container custom-container">
          <div className="row justify-content-between align-items-center">
            ...
            <div className="col-xl-5 col-lg-6">
              <div className="h-seven-slider-img text-center">
                <img src="assets/img/slider/shop_slider_img03.png" data-animation-in="slideInRightS" data-delay-in=".4" alt="BrandImg" />
              </div>
            </div>
          </div>
        </div>
