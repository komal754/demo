      ...
      <div className="row gs-category-active" >
        <div className="col-5 grid-item">
          <div className="gs-category-item mb-20">
            <div className="thumb"><a href="/#"><img src="assets/img/product/gs_popular_item01.jpg" alt="BrandImg" /></a></div>
        ...
        <div className="col-3 grid-item">
          <div className="gs-category-item style-two green-bg mb-20">
            <div className="thumb"><a href="/#"><img src="assets/img/product/gs_popular_item02.jpg" alt="BrandImg" /></a></div>
            <div className="content">
        ...
        <div className="col-3 grid-item">
          <div className="gs-category-item style-two mb-20">
            <div className="thumb"><a href="/#"><img src="assets/img/product/gs_popular_item03.jpg" alt="BrandImg" /></a></div>
            <div className="content">
        ...
        <div className="col-3 grid-item">
          <div className="gs-category-item style-two mb-20">
            <div className="thumb"><a href="/#"><img src="assets/img/product/gs_popular_item04.jpg" alt="BrandImg" /></a></div>
            <div className="content">
              <h4><a href="/#">gaming chair pillow</a></h4>
              <a href="/#" className="shop-link">Shop Now <i className="fas fa-angle-right" /></a>
            </div>
        ...
        <div className="col-3 grid-item">
          <div className="gs-category-item style-two mb-20">
            <div className="thumb"><a href="/#"><img src="assets/img/product/gs_popular_item05.jpg" alt="BrandImg" /></a></div>
            <div className="content">
