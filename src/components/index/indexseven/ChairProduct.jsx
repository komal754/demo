    ...
    <div className="container">
      ...
      <div className="row justify-content-center">
        <div className="col-lg-4 col-md-6 col-sm-8">
          <div className="chair-product-item mb-60">
            <div className="chair-product-thumb">
              <img src="assets/img/product/gaming_chair01.jpg" alt="BrandImg" />
        ...
        <div className="col-lg-4 col-md-6 col-sm-8">
          <div className="chair-product-item mb-60">
            <div className="chair-product-thumb">
              <img src="assets/img/product/gaming_chair02.jpg" alt="BrandImg" />
              <a href="/#" className="cart">Add to cart <i className="fas fa-shopping-basket" /></a>
            </div>
            <div className="chair-product-content">
              <div className="chair-product-top-content">
        ...
        <div className="col-lg-4 col-md-6 col-sm-8">
          <div className="chair-product-item mb-60">
            <div className="chair-product-thumb">
              <img src="assets/img/product/gaming_chair03.jpg" alt="BrandImg" />
              <a href="/#" className="cart">Add to cart <i className="fas fa-shopping-basket" /></a>
            </div>
            <div className="chair-product-content">
              <div className="chair-product-top-content">
        ...
        <div className="col-lg-4 col-md-6 col-sm-8">
          <div className="chair-product-item mb-60">
            <div className="chair-product-thumb">
              <img src="assets/img/product/gaming_chair04.jpg" alt="BrandImg" />
              <a href="/#" className="cart">Add to cart <i className="fas fa-shopping-basket" /></a>
            </div>
            <div className="chair-product-content">
              <div className="chair-product-top-content">
        ...
        <div className="col-lg-4 col-md-6 col-sm-8">
          <div className="chair-product-item mb-60">
            <div className="chair-product-thumb">
              <img src="assets/img/product/gaming_chair05.jpg" alt="BrandImg" />
              <a href="/#" className="cart">Add to cart <i className="fas fa-shopping-basket" /></a>
            </div>
            <div className="chair-product-content">
              <div className="chair-product-top-content">
        ...
        <div className="col-lg-4 col-md-6 col-sm-8">
          <div className="chair-product-item mb-60">
            <div className="chair-product-thumb">
              <img src="assets/img/product/gaming_chair06.jpg" alt="BrandImg" />
              <a href="/#" className="cart">Add to cart <i className="fas fa-shopping-basket" /></a>
            </div>
            <div className="chair-product-content">
              <div className="chair-product-top-content">
