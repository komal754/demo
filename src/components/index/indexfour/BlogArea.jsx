    ...
    <div className="container">
      ...
      <div className="row justify-content-center">
        <div className="col-lg-4 col-md-6 col-sm-9">
          <div className="blog-post home-four-blog-post mb-50">
            <div className="blog-thumb mb-30">
              <a href="/#"><img src="assets/img/blog/home_four_blog_thumb01.jpg" alt="BrandImg" /></a>
            </div>
            <div className="blog-post-content">
              <div className="blog-meta">
                <ul>
                  <li><i className="far fa-user" /><a href="/#">Admin</a></li>
                  <li><i className="far fa-calendar-alt" />september 19, 2020</li>
                </ul>
              </div>
        ...
        <div className="col-lg-4 col-md-6 col-sm-9">
          <div className="blog-post home-four-blog-post mb-50">
            <div className="blog-thumb mb-30">
              <a href="/#"><img src="assets/img/blog/home_four_blog_thumb02.jpg" alt="BrandImg" /></a>
            </div>
            <div className="blog-post-content">
              <div className="blog-meta">
                <ul>
        ...
        <div className="col-lg-4 col-md-6 col-sm-9">
          <div className="blog-post home-four-blog-post mb-50">
            <div className="blog-thumb mb-30">
              <a href="/#"><img src="assets/img/blog/home_four_blog_thumb03.jpg" alt="BrandImg" /></a>
            </div>
            <div className="blog-post-content">
              <div className="blog-meta">
                <ul>
