    ...
    <div className="container">
      ...
      <Slider className="row product-active"{...settings}>
        <div className="col-xl">
          <div className="shop-item">
            <div className="product-thumb">
              <a href="/#"><img src="assets/img/product/s_product_img01.jpg" alt="BrandImg" /></a>
            </div>
        ...
        <div className="col-xl">
          <div className="shop-item">
            <div className="product-thumb">
              <a href="/#"><img src="assets/img/product/s_product_img02.jpg" alt="BrandImg" /></a>
            </div>
            <div className="product-content">
        ...
        <div className="col-xl">
          <div className="shop-item">
            <div className="product-thumb">
              <a href="/#"><img src="assets/img/product/s_product_img03.jpg" alt="BrandImg" /></a>
            </div>
            <div className="product-content">
