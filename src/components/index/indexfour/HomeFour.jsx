        ...
        <div className="row justify-content-center">
          <div className="col-xl-8 col-lg-9">
            <div className="live-match-wrap">
              <img src="assets/img/images/live_match_img.jpg" alt="BrandImg" />
              <a href="https://www.youtube.com/watch?v=04KPiGmC7Lc" className="popup-video"><img src="assets/img/icon/video_play_icon.png" alt="BrandImg" /></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="live-match-team">
              <img src="assets/img/team/live_match_logo01.png" alt="BrandImg" />
            </div>
          </div>
          <div className="col-lg-4">
          ...
          <div className="col-lg-4">
            <div className="live-match-team right">
              <img src="assets/img/team/live_match_logo02.png" alt="BrandImg" />
            </div>
          </div>
        </div>
      </div>
