              ...
              <div className="row">
                    ...
                    <ul>
                      <li>
                        <div className="just-gamers-list-icon">
                          <img src="assets/img/icon/gamer_list_icon01.png" alt="BrandImg" />
                        </div>
                      ...
                      <li>
                        <div className="just-gamers-list-icon">
                          <img src="assets/img/icon/gamer_list_icon02.png" alt="BrandImg" />
                        </div>
                        <div className="just-gamers-list-content fix">
                      ...
                      <li>
                        <div className="just-gamers-list-icon">
                          <img src="assets/img/icon/gamer_list_icon03.png" alt="BrandImg" />
                        </div>
                        <div className="just-gamers-list-content fix">
                ...
                <div className="col-xl-7 col-lg-6 d-none d-lg-block">
                  <div className="just-gamers-img">
                    <img src="assets/img/images/just_gamers_img.png" alt="BrandImg" className="just-gamers-character" />
                    <div className="just-gamers-circle-shape">
                      <img src="assets/img/images/gamers_circle_line.png" alt="BrandImg" />
                      <img src="assets/img/images/gamers_circle_shape.png" alt="BrandImg" className="rotateme" />
                    </div>
                    <img src="assets/img/images/just_gamers_chart.png" alt="BrandImg" className="gamers-chart-shape" />
                  </div>
                </div>
              </div>
            </div>
