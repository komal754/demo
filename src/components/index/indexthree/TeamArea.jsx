            ...
            <div className="container custom-container">
              ...
              <div className="row justify-content-center">
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                  <div className="third-team-item text-center mb-30">
                    <div className="third-team-img">
                      <img src="assets/img/team/team_img01.png" alt="BrandImg" />
                    </div>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                  <div className="third-team-item text-center mb-30">
                    <div className="third-team-img">
                      <img src="assets/img/team/team_img02.png" alt="BrandImg" />
                    </div>
                    <div className="third-team-content">
                      <div className="main-bg" />
                      <div className="hover-bg" />
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                  <div className="third-team-item text-center mb-30">
                    <div className="third-team-img">
                      <img src="assets/img/team/team_img03.png" alt="BrandImg" />
                    </div>
                    <div className="third-team-content">
                      <div className="main-bg" />
                      <div className="hover-bg" />
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                  <div className="third-team-item text-center mb-30">
                    <div className="third-team-img">
                      <img src="assets/img/team/team_img04.png" alt="BrandImg" />
                    </div>
                    <div className="third-team-content">
                      <div className="main-bg" />
                      <div className="hover-bg" />
