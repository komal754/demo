              ...
              <Slider className="row game-gallery-active" {...settings}>
                <div className="col-12">
                  <div className="game-gallery-item">
                    <img src="assets/img/images/game_gallery_01.png" alt="BrandImg" />
                  </div>
                </div>
                <div className="col-12">
                  <div className="game-gallery-item">
                    <img src="assets/img/images/game_gallery_02.png" alt="BrandImg" />
                  </div>
                </div>
                <div className="col-12">
                  <div className="game-gallery-item">
                    <img src="assets/img/images/game_gallery_03.png" alt="BrandImg" />
                  </div>
                </div>
                <div className="col-12">
                  <div className="game-gallery-item">
                    <img src="assets/img/images/game_gallery_04.png" alt="BrandImg" />
                  </div>
                </div>
              </Slider>
            </div>
