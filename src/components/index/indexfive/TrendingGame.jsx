              ...
              <div className="trending-gameplay-item mb-50">
                <div className="gameplay-thumb">
                  <a href="https://www.youtube.com/watch?v=ssrNcwxALS4" className="popup-video">
                    <img src="assets/img/icon/v_play.png" alt="BrandImg" className="play" />
                    <img src="assets/img/images/trending_thumb01.jpg" alt="BrandImg" />
                  </a>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="trending-gameplay-item mb-50">
                <div className="gameplay-thumb">
                  <a href="https://www.youtube.com/watch?v=ssrNcwxALS4" className="popup-video">
                    <img src="assets/img/icon/v_play.png" alt="BrandImg" className="play" />
                    <img src="assets/img/images/trending_thumb02.jpg" alt="BrandImg" />
                  </a>
                  <div className="treand-gameplay-overlay">
                    <ul>
                      <li className="duration">01 :45</li>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="trending-gameplay-item mb-50">
                <div className="gameplay-thumb">
                  <a href="https://www.youtube.com/watch?v=ssrNcwxALS4" className="popup-video">
                    <img src="assets/img/icon/v_play.png" alt="BrandImg" className="play" />
                    <img src="assets/img/images/trending_thumb03.jpg" alt="BrandImg" />
                  </a>
                  <div className="treand-gameplay-overlay">
                    <ul>
                      <li className="duration">01 :45</li>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="trending-gameplay-item mb-50">
                <div className="gameplay-thumb">
                  <a href="https://www.youtube.com/watch?v=ssrNcwxALS4" className="popup-video">
                    <img src="assets/img/icon/v_play.png" alt="BrandImg" className="play" />
                    <img src="assets/img/images/trending_thumb04.jpg" alt="BrandImg" />
                  </a>
                  <div className="treand-gameplay-overlay">
                    <ul>
                      <li className="duration">01 :45</li>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="trending-gameplay-item mb-50">
                <div className="gameplay-thumb">
                  <a href="https://www.youtube.com/watch?v=ssrNcwxALS4" className="popup-video">
                    <img src="assets/img/icon/v_play.png" alt="BrandImg" className="play" />
                    <img src="assets/img/images/trending_thumb05.jpg" alt="BrandImg" />
                  </a>
                  <div className="treand-gameplay-overlay">
                    <ul>
                      <li className="duration">01 :45</li>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="trending-gameplay-item mb-50">
                <div className="gameplay-thumb">
                  <a href="https://www.youtube.com/watch?v=ssrNcwxALS4" className="popup-video">
                    <img src="assets/img/icon/v_play.png" alt="BrandImg" className="play" />
                    <img src="assets/img/images/trending_thumb06.jpg" alt="BrandImg" />
                  </a>
                  <div className="treand-gameplay-overlay">
                    <ul>
                      <li className="duration">01 :45</li>
