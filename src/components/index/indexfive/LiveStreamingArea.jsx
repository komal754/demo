      ...
      <div className="row">
        <div className="col-xl-8 col-lg-7">
          <div className="live-stream-item mb-30">
            <div className="thumb">
              <img src="assets/img/images/stream_thumb01.jpg" alt="BrandImg" />
              <Link className="popup-video" to="https://www.youtube.com/watch?v=ssrNcwxALS4" ><img src="assets/img/icon/w_play.png" alt="BrandImg" /></Link>
            </div>
          ...
          <div className="row">
            <div className="col-lg-12 col-md-6">
              <div className="live-stream-item style-two mb-30">
                <div className="thumb">
                  <img src="assets/img/images/stream_thumb02.jpg" alt="BrandImg" />
                </div>
                <div className="content">
                  <a href="https://www.youtube.com/watch?v=ssrNcwxALS4" className="popup-video"><img src="assets/img/icon/w_play.png" alt="BrandImg" /></a>
                  <div className="live-stream-meta">
                    <ul>
            ...
            <div className="col-lg-12 col-md-6">
              <div className="live-stream-item style-two mb-30">
                <div className="thumb">
                  <img src="assets/img/images/stream_thumb03.jpg" alt="BrandImg" />
                </div>
                <div className="content">
                  <a href="https://www.youtube.com/watch?v=ssrNcwxALS4" className="popup-video"><img src="assets/img/icon/w_play.png" alt="BrandImg" /></a>
                  <div className="live-stream-meta">
