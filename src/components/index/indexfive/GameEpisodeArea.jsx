      ...
      <div className="episodes-wrapper">
        ...
        <div className="col-lg">
            <div className="game-episodes-item">
              <div className="thumb">
                <img src="assets/img/images/episode_thumb01.jpg" alt="BrandImg" />
          ...
          <div className="col-lg">
            <div className="game-episodes-item">
              <div className="thumb">
                <img src="assets/img/images/episode_thumb02.jpg" alt="BrandImg" />
                <div className="episodes-tags">
                  <a href="/#">sports</a>
                </div>
              </div>
          ...
          <div className="col-lg">
            <div className="game-episodes-item">
              <div className="thumb">
                <img src="assets/img/images/episode_thumb03.jpg" alt="BrandImg" />
                <div className="episodes-tags">
                  <a href="/#">sports</a>
                </div>
              </div>
          ...
          <div className="col-lg">
            <div className="game-episodes-item">
              <div className="thumb">
                <img src="assets/img/images/episode_thumb04.jpg" alt="BrandImg" />
                <div className="episodes-tags">
                  <a href="/#">sports</a>
                </div>
              </div>
