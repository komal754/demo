    ...
    <div className="container">
      ...
      <div className="row justify-content-center">
        <div className="col-lg-4 col-md-6">
          <div className="video-blog-item mb-50">
            <div className="video-blog-thumb">
              <a href="/blog-details"><img src="assets/img/blog/h5_blog_thumb01.jpg" alt="BrandImg" /></a>
            </div>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="video-blog-item mb-50">
            <div className="video-blog-thumb">
              <a href="/blog-details"><img src="assets/img/blog/h5_blog_thumb02.jpg" alt="BrandImg" /></a>
            </div>
            <div className="video-blog-content">
              <div className="video-blog-meta">
                <ul>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="video-blog-item mb-50">
            <div className="video-blog-thumb">
              <a href="/blog-details"><img src="assets/img/blog/h5_blog_thumb03.jpg" alt="BrandImg" /></a>
            </div>
            <div className="video-blog-content">
              <div className="video-blog-meta">
                <ul>
