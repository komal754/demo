        ...
        <div className="col-12">
          ...
          <Slider className="banner-magazine-active" {...settings}>
                    ...
                    <div className="banner-magazine-thumb">
                        ...
                        <img src="assets/img/slider/banner_magazine_thumb02.jpg" alt="BrandImg" />
                    </div>
                    ...
                    <div className="banner-magazine-thumb">
                        <div className="tags"><a href="/#">sports</a></div>
                        <img src="assets/img/slider/banner_magazine_thumb03.jpg" alt="BrandImg" />
                    </div>
                    <div className="banner-magazine-content">
                        <span className="date">December 19, 2022</span>
                    ...
                    <div className="banner-magazine-thumb">
                        <div className="tags"><a href="/#">sports</a></div>
                        <img src="assets/img/slider/banner_magazine_thumb04.jpg" alt="BrandImg" />
                    </div>
                    <div className="banner-magazine-content">
                        <span className="date">December 19, 2022</span>
                        <h5 className="title"><a href="/#">Hunger still quite persists in many of India's tribal</a></h5>
                    ...
                    <div className="banner-magazine-thumb">
                        <div className="tags"><a href="/#">sports</a></div>
                        <img src="assets/img/slider/banner_magazine_thumb05.jpg" alt="BrandImg" />
                    </div>
                    <div className="banner-magazine-content">
                        <span className="date">December 19, 2022</span>
                        <h5 className="title"><a href="/#">Hunger still quite persists in many of India's tribal</a></h5>
                    ...
                    <div className="banner-magazine-thumb">
                        <div className="tags"><a href="/#">sports</a></div>
                        <img src="assets/img/slider/banner_magazine_thumb01.jpg" alt="BrandImg" />
                    </div>
                    <div className="banner-magazine-content">
                        <span className="date">December 19, 2022</span>
