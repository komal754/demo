            ...
            <div className="col-md">
              <div className="trending-news-item overlay-item">
                <div className="trend-news-thumb">
                  <img src="assets/img/blog/trand_news_thumb01.jpg" alt="BrandImg" />
                </div>
            ...
            <div className="col-md">
              <Slider className="trending-news-active" {...settings}>
                <div className="trending-news-item horizontal-item yellow">
                  <div className="trend-news-thumb">
                    <a href="/#"><img src="assets/img/blog/trand_news_thumb02.jpg" alt="BrandImg" /></a>
                  </div>
                  <div className="trend-news-content">
                    <div className="tags"><a href="/#">sports</a></div>
                    <span className="date">December 19, 2022</span>
                ...
                <div className="trending-news-item horizontal-item blue">
                  <div className="trend-news-thumb">
                    <a href="/#"><img src="assets/img/blog/trand_news_thumb03.jpg" alt="BrandImg" /></a>
                  </div>
                  <div className="trend-news-content">
                ...
                <div className="trending-news-item horizontal-item">
                  <div className="trend-news-thumb">
                    <a href="/#"><img src="assets/img/blog/trand_news_thumb04.jpg" alt="BrandImg" /></a>
                  </div>
                  <div className="trend-news-content">
                ...
                <div className="trending-news-item horizontal-item blue">
                  <div className="trend-news-thumb">
                    <a href="/#"><img src="assets/img/blog/trand_news_thumb05.jpg" alt="BrandImg" /></a>
                  </div>
                  <div className="trend-news-content">
                    <div className="tags"><a href="/#">game</a></div>
                    <span className="date">December 19, 2022</span>
          ...
          <aside className="home-sidebar-news">
            ...
            <div className="row">
              <div className="col-sm-6">
                <div className="sidebar-popular-item">
                  <div className="sp-thumb">
                    <a href="/#"><img src="assets/img/blog/popular_post_thumb01.jpg" alt="BrandImg" /></a>
                  </div>
              ...
              <div className="col-sm-6">
                <div className="sidebar-popular-item">
                  <div className="sp-thumb">
                    <a href="/#"><img src="img/blog/popular_post_thumb02.jpg" alt="BrandImg" /></a>
                  </div>
                  <div className="sp-content">
                    <span className="date">35 minute ago</span>
            ...
            <div className="popular-banner-ad">
              <a href="/#"><img src="assets/img/images/popular_banner.jpg" alt="BrandImg" /></a>
            </div>
          </aside>
        </div>
        <div className="col-12">
          <div className="magazine-banner-ad">
            <a href="/#"><img src="assets/img/images/buy_banner.jpg" alt="BrandImg" /></a>
          </div>
        </div>
      </div>
    </div>
