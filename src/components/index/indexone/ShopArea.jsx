          ...
          <div className="container">
            ...
            <Slider className="row product-active "{...settings}>
              <div className="col-xl">
                <div className="shop-item">
                  <div className="product-thumb">
                    <a href="/#"><img src="assets/img/product/product_img01.jpg" alt="BrandImg" /></a>
                  </div>
              ...
              <div className="col-xl">
                <div className="shop-item">
                  <div className="product-thumb">
                    <a href="/#"><img src="assets/img/product/product_img02.jpg" alt="BrandImg" /></a>
                  </div>
                  <div className="product-content">
              ...
              <div className="col-xl">
                <div className="shop-item">
                  <div className="product-thumb">
                    <a href="/#"><img src="assets/img/product/product_img03.jpg" alt="BrandImg" /></a>
                  </div>
                  <div className="product-content">
              ...
              <div className="col-xl">
                <div className="shop-item">
                  <div className="product-thumb">
                    <a href="/#"><img src="assets/img/product/product_img04.jpg" alt="BrandImg" /></a>
                  </div>
                  <div className="product-content">
                  ...
                  <div className="blog-post-wrap">
                    <div className="blog-post-item blog-style-one">
                      <div className="blog-thumb">
                        <a href="/#"><img src="assets/img/blog/blog_thumb01.jpg" alt="BrandImg" /></a>
                      </div>
                    ...
                    <div className="blog-post-item blog-style-one">
                      <div className="blog-thumb">
                        <a href="/#"><img src="assets/img/blog/blog_thumb02.jpg" alt="BrandImg" /></a>
                      </div>
                      <div className="blog-post-content">
                    ...
                    <div className="blog-post-item blog-style-one">
                      <div className="blog-thumb">
                        <a href="/#"><img src="assets/img/blog/blog_thumb03.jpg" alt="BrandImg" /></a>
                      </div>
                      <div className="blog-post-content">
