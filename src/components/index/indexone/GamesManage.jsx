                ...
                <div className="coming-match-team">
                  <div className="match-team-info">
                    <div className="match-team-logo">
                      <a href="/#"><img src="assets/img/team/team_logo01.png" alt="BrandImg" /></a>
                    </div>
                  ...
                  <div className="coming-match-status">
                    <img src="assets/img/team/match_vs.png" alt="BrandImg" />
                  </div>
                  <div className="match-team-info">
                    <div className="match-team-logo">
                      <a href="/#"><img src="assets/img/team/team_logo02.png" alt="BrandImg" /></a>
                    </div>
                    <div className="match-team-name">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="coming-match-item mb-30">
                <div className="coming-match-team">
                  <div className="match-team-info">
                    <div className="match-team-logo">
                      <a href="/#"><img src="assets/img/team/team_logo03.png" alt="BrandImg" /></a>
                    </div>
                    <div className="match-team-name">
                      <a href="/#">Bluster 8</a>
                    </div>
                  ...
                  <div className="match-team-info">
                    <div className="match-team-logo">
                      <a href="/#"><img src="assets/img/team/team_logo04.png" alt="BrandImg" /></a>
                    </div>
                    <div className="match-team-name">
                      <a href="/#">The Champ</a>
                    </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="coming-match-item mb-30">
                <div className="coming-match-team">
                  <div className="match-team-info">
                    <div className="match-team-logo">
                      <a href="/#"><img src="assets/img/team/team_logo05.png" alt="BrandImg" /></a>
                    </div>
                    <div className="match-team-name">
                      <a href="/#">Warrior</a>
                    </div>
                  ...
                  <div className="match-team-info">
                    <div className="match-team-logo">
                      <a href="/#"><img src="assets/img/team/team_logo06.png" alt="BrandImg" /></a>
                    </div>
                    <div className="match-team-name">
                      <a href="/#">kill bill 7</a>
                    </div>
                                            ...
                                            <div className="row no-gutters">
                                                <div className="col-lg-4">
                                                    <div className="tournament-schedule-item">
                                                        <div className="match-team-info">
                                                              <div className="match-team-logo">
                                                                <a href="/#"><img src={image1} alt="BrandImg" /></a>
                                                              </div>
                                                        </div>
                                                          <div className="coming-match-status">
                                                            <img src={image2} alt="BrandImg" />
                                                          </div>
                                                          <div className="match-team-info">
                                                            <div className="match-team-logo">
                                                              <a href="/#"><img src={image3} alt="BrandImg" /></a>
                                                            </div>
                                                          </div>
                                                    </div>
                                                </div>
