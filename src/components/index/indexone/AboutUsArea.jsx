            ...
            <div className="row">
              <div className="col-lg-6 order-0 order-lg-2">
                <div className="about-img">
                  <img src="assets/img/images/about_us_img.jpg" alt="BrandImg" />
                  <Link to="/https://www.youtube.com/watch?v=_LTiEXMc5J0" className="popup-video"><img src="assets/img/icon/play_btn.png" alt="BrandImg" /></Link>
                </div>
              </div>
