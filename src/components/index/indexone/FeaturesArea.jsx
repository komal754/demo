                  ...
                  <ul>
                    <li>
                      <div className="features-list-img">
                        <img src="assets/img/images/features_thumb01.jpg" alt="BrandImg" />
                      </div>
                    ...
                    <li>
                      <div className="features-list-img">
                        <img src="assets/img/images/features_thumb02.jpg" alt="BrandImg" />
                      </div>
                      <div className="features-list-content">
              ...
              <div className="features-item mb-30">
                ...
                <div className="features-list-wrap">
                  <ul>
                    <li>
                      <div className="features-list-img">
                        <img src="assets/img/images/features_thumb03.jpg" alt="BrandImg" />
                      </div>
                      <div className="features-list-content">
                        <div className="product-tag"><a href="/#">zombie</a></div>
                        <h6><a href="/#">Design compose copratin</a></h6>
                    ...
                    <li>
                      <div className="features-list-img">
                        <img src="assets/img/images/features_thumb04.jpg" alt="BrandImg" />
                      </div>
                      <div className="features-list-content">
                        <div className="product-tag"><a href="/#">shooter</a></div>
                        <h6><a href="/#">Who hangs around the streets</a></h6>
              ...
              <div className="features-item mb-30">
                ...
                <div className="features-list-wrap">
                  <ul>
                    <li>
                      <div className="features-list-img">
                        <img src="assets/img/images/features_thumb05.jpg" alt="BrandImg" />
                      </div>
                      <div className="features-list-content">
                        <div className="product-tag"><a href="/#">zombie</a></div>
                        <h6><a href="/#">Who hangs around the streets</a></h6>
                    ...
                    <li>
                      <div className="features-list-img">
                        <img src="assets/img/images/features_thumb06.jpg" alt="BrandImg" />
                      </div>
                      <div className="features-list-content">
                        <div className="product-tag"><a href="/#">shooter</a></div>
                        <h6><a href="/#">Design compose copratin</a></h6>
