	    ...
	    <div className="fact-area pt-90">
            <div className="row justify-content-center">
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="fact-item">
                  <div className="fact-icon">
                    <img src="assets/img/icon/fact_icon01.png" alt="BrandImg" />
                  </div>
              ...
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="fact-item">
                  <div className="fact-icon">
                    <img src="assets/img/icon/fact_icon02.png" alt="BrandImg" />
                  </div>
                  <div className="counter-item">
              ...
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="fact-item">
                  <div className="fact-icon">
                    <img src="assets/img/icon/fact_icon03.png" alt="BrandImg" />
                  </div>
                  <div className="counter-item">
              ...
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="fact-item">
                  <div className="fact-icon">
                    <img src="assets/img/icon/fact_icon04.png" alt="BrandImg" />
                  </div>
                  <div className="counter-item">
