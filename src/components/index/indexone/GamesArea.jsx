                ...
                <Slider className="latest-games-active slick" {...settings}>
                  <div className="latest-games-items mb-30">
                    <div className="latest-games-thumb">
                      <a href="/#"><img src="assets/img/product/latest_games_thumb01.jpg" alt="BrandImg" /></a>
                    </div>
                  ...
                  <div className="latest-games-items mb-30">
                    <div className="latest-games-thumb">
                      <a href="/#"><img src="assets/img/product/latest_games_thumb02.jpg" alt="BrandImg" /></a>
                    </div>
                    <div className="latest-games-content">
                      <div className="lg-tag">
                        <a href="/#">zombie</a>
                  ...
                  <div className="latest-games-items mb-30">
                    <div className="latest-games-thumb">
                      <a href="/#"><img src="assets/img/product/latest_games_thumb03.jpg" alt="BrandImg" /></a>
                    </div>
                    <div className="latest-games-content">
                      <div className="lg-tag">
                        <a href="/#">creative</a>
