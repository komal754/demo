                      ...
                      <ul>
                        <li>
                          <div className="header-top-mail">
                            <p><span>|</span><i className="far fa-envelope" /><a href="mailto:info@Mat49Circle.com">info@Mat49Circle.com</a></p>
                          </div>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="row">
                ...
                <div className="mobile-nav-toggler two"><i className="fas fa-bars" /></div>
                  <div className="main-menu  menu-style-two" >
                    <nav>
                      <div className="logo">
                        <Link to="/"><img src="assets/img/brand/brand_trans2.png" width="80px" alt="Logo" /></Link>
                      </div>
                      <div className="navbar-wrap push-menu d-none d-lg-flex">
                        <ul className="navigation">
                          ...
                          <li className='menu-item-has-children'><Link >Games</Link>
                            <ul className="submenu">
                              {/* <li><Link to="/upcoming-games">Upcoming Games</Link></li> */}
                              <li><Link to="/ludo">Ludo</Link></li>
                              <li><Link to="/rummy">Rummy</Link></li>
                              <li><Link to="/teenPatti">Teen Patti</Link></li>
                              <li><Link to="/callBreak">Call-Break</Link></li>
                            </ul>
                          </li>
                          {/* <li><Link to="/overview">Tournaments</Link></li> */}
                            ...
                            <ul className="minicart">
                              <li className="d-flex align-items-start">
                                <div className="cart-img">
                                  <a href="/#">
                                    <img src="assets/img/product/cart_p01.jpg" alt="BrandImg" />
                                  </a>
                                </div>
                 ...
                 <div className="mobile-menu">
                  <nav className="menu-box">
                    ...
                    <div className="nav-logo" style={{display:"flex",justifyContent:"center"}}><Link to="/"><img src="assets/img/brand/brand_trans.png" alt="BrandImg" title='true' /></Link>
                    </div>
