                    ...
                    <ul>
                      <li>
                        <div className="header-top-mail">
                          <p><span>|</span><i className="far fa-envelope" /><Link to="/contact">info@Mat49Circle.com</Link></p>
                        </div>
                      </li>
                      <li>
              ...
              <div className="mobile-nav-toggler"><i className="fas fa-bars" /></div>
               ...
               <div className="mobile-menu">
                  <nav className="menu-box">
                    ...
                    <div className="nav-logo"><Link to="/"><img src="assets/img/logo/logo.png" alt="BrandImg" title='true' /></Link>
                    </div>
